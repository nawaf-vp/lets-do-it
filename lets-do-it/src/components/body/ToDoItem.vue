<template>
    <div class="to-do-item">
        ...
        <input class="item" v-bind:class="{completed:item.completed}" v-bind:disabled="!isEditing" 
               v-model="item.title" v-on:keyup.enter="updateItem"/>
        <div class="item-right">
            <i class="fas fa-edit green" @click="isEditing= true"></i>
            <i class="fas fa-edit red" @click="deleteItem(item.id)"></i>
